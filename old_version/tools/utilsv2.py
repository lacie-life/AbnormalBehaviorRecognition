...
from dataset.dataset import FrameDataset
from dataset.dynamic_dataset import DynamicFrameDataset
...
def get_loader(origin_path, phase, batch_size=4, num_workers=8, dynamic=False, num_frames=16, slowfast=False):
    path = origin_path + '/{}'.format(phase)
