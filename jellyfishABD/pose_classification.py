...
model.load_state_dict(torch.load('/home/lacie/Github/AbnormalBehaviorRecognition/pose_resnext_50_epochs.pth'))
...
img = cv2.imread('/home/lacie/Github/AbnormalBehaviorRecognition/data/data_pose/images/fall/63.jpg')
